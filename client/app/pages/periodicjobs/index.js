...
const cronTriggerRegex = {
  yearRegex: '^((\\*)|\\d{4,4})(?:,((\\*)|\\d{4,4}))*$',
  monthRegex: '^((\\*)|(0?\\d{1,1})|(1[0-2]))(?:,((\\*)|(0?\\d{1,1})|(1[0-2])))*$',
  dayRegex: '^((\\*)|(\\d{1,1})|([0-2]\\d{1,1})|(3[01]))(?:,((\\*)|(\\d{1,1})|([0-2]\\d{1,1})|(3[01])))*$',
  hourRegex: '^((\\*)|(\\d{1,1})|([0-1]\\d{1,1})|(2[0-3]))(?:,((\\*)|(\\d{1,1})|([0-1]\\d{1,1})|(2[0-3])))*$',
  minuteRegex: '^((\\*)|(\\d{1,1})|([0-5]\\d{1,1}))(?:,((\\*)|(\\d{1,1})|([0-5]\\d{1,1})))*$',
  secondRegex: '^((\\*)|(\\d{1,1})|([0-5]\\d{1,1}))(?:,((\\*)|(\\d{1,1})|([0-5]\\d{1,1})))*$',
};
